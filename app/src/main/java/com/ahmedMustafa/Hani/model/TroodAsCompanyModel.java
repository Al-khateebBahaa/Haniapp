...
public class TroodAsCompanyModel {
    ...
    public static class MyOrder {
        ...
        @SerializedName("second_total_price")
        @Expose
        private Integer secondTotalPrice;
        ...
        public Integer getSecondTotalPrice() {
            return secondTotalPrice;
        }

        public void setSecondTotalPrice(Integer secondTotalPrice) {
