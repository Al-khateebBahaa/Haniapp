...
public class StoreFragment extends BaseFragment {
  ...
  //  private View search;
    ...
    private void bind(View v) {
     ...
     //   ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("المتاجر");
      ...
      //  activeRecycler = v.findViewById(R.id.activRecycler);
       ...
       // search.setVisibility(View.GONE);
        ((TextView) v.findViewById(R.id.toolbar_title)).setText("المتاجر");
    ...
    private void init() {
        activeAdapter.setType(Constant.STORE);
        nearbyAdapter.setType(Constant.STORE);
...
/*
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("type", Constant.STORE);
                i.putExtra("typee", "s");
                openActivity(i);
            }
        });
    ...
    protected void loadData() {
        ...
        if (gpsTracker.isCanGetLocation()) {
            ...
            Log.e("lat", gpsTracker.getLat() + "");
            Log.e("lng", gpsTracker.getLon() + "");

            getApi().getNearbyRestaurant(gpsTracker.getLat() + "", gpsTracker.getLon() + "", "store")
