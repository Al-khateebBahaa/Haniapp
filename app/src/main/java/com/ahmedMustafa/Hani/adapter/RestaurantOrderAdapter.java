...
public class RestaurantOrderAdapter extends BaseAdapter<RestaurantOrdersModel.Order, RestaurantOrderAdapter.OrderHolder> {

    public @Inject
    RestaurantOrderAdapter(Context context) {
        super(context);
    }
